...
import './service/1_choose_input_method.dart' show ChooseIPMPage;
  ...
  Widget build(BuildContext context) {
    ...
    return BasePage(
        ...
        singleChildScrollView: SingleChildScrollView(
          child: Padding(
            padding: EdgeInsets.fromLTRB(imagePaddingValue, 0,
                imagePaddingValue, 0), // Set top and bottom padding to 0
            child: Align(
